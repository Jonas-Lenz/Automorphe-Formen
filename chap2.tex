...
\end{proof}
\end{satz}
%TODO Beweis sollte mal vollstaendig sein.
...
\end{cor}
%\begin{proof}
%Starte mit $n=1$ und reduziere modulo p^richtiger Exponent. Eindeutigkeit folgt aus Satz.
%\end{proof}
%TODO wie geht das wirklich?

%das folgende ist teil des beweises von 2.17
...
Dies liefert nach der bisherigen analytischen Beschreibung von $\Q_p$ und $\Z_p$ nun auch eine algebraische Beschreibung.
...
\end{proof}
%TODO hier Urbilder hinschreiben
